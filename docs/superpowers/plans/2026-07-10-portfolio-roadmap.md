...
|---|------|------|--------|------------|
| 0 | Fundaciones (monorepo, tooling, CI, config agentes) | `2026-07-10-phase-0-foundations.md` | ✅ escrito | — |
| 1 | Design system (tokens, theming, primitivas UI, showcase) | just-in-time | pendiente | 0 |
