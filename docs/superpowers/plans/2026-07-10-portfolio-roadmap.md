...
| 3.6 | Showcase UX v2 + media-kit 0.5 (transiciones, filtro real, tabs estables, fix mouse-follow fullscreen, tooltips con delay, nueva colorización, componentes de impacto visual seleccionados) | `2026-07-17-phase-3.6-showcase-mediakit.md` (spec propia `2026-07-16-phase-3.6-…-design.md`) | pendiente | 2.6, 3, 3.5                         |
