...
| Comentarios en código   | **SIEMPRE en inglés** (regla dura: comentarios en línea, JSDoc y descripciones de tests deben estar en inglés; el diálogo y documentación pueden ser en español)                                                                                                                                                                                                                                            |
