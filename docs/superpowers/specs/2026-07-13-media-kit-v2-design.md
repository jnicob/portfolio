...
| Contenido de la toolbar | Zoom − / indicador % / zoom +, reset, ciclo de fit, fullscreen nativo (con detección de soporte), cerrar. El toggle de visibilidad va fuera, siempre visible |
