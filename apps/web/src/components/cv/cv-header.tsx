  ...
  return (
    <header className="flex flex-col gap-2 border-b border-border pb-2.5 print:pb-2 print:gap-1.5">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <h1 className="text-5xl font-bold tracking-tight text-fg print:text-4xl">{profile.name}</h1>
          <p className="text-xl text-fg-muted print:text-base font-medium">{profile.headline[locale]}</p>
        </div>
