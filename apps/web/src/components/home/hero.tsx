...
/**
 * Hero de home: headline + summary del profile (LCP de la página) y CTA al CV.
 * RSC-compatible: `HeroCanvas` es el único client island, montado como primer
 * hijo detrás del contenido (`position: relative` en ambos para el stacking).
 */
